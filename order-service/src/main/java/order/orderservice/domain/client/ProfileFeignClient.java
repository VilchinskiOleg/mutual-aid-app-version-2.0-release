...
@FeignClient(value = "profileClient", url = "${profile-rest.url}", configuration = ProfileFeignClientConfig.class)
public interface ProfileFeignClient {

    @GetMapping("/{profile-id}")
    Profile getProfileByInternalId(@PathVariable("profile-id") String profileId,
