...
public class Constant {
    ...
    public static class Service {
        ...
        public static class Strategy {
            ...
            public static final String CHOOSE_ORDER_STRATEGY = "chooseOrderStrategy";
            public static final String APPROVE_ORDER_STRATEGY = "approveOrderStrategy";
            public static final String CLOSE_ORDER_STRATEGY = "closeOrderStrategy";
        }
    }
