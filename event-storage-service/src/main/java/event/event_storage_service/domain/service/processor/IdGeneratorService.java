package event.event_storage_service.domain.service.processor;

import static event.event_storage_service.util.Constant.Service.GENERATE_ID_U_64_LOCAL_MASK;
import static event.event_storage_service.util.Constant.Service.GENERATE_ID_U_64_TICKS_MASK;
import static event.event_storage_service.util.Constant.Service.GLOBAL_MARK_START_COUNT_TIME_BY_GREGORIAN;
