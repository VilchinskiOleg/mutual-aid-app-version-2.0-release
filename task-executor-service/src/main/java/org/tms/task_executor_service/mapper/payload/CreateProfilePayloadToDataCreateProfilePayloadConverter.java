...
@Component
public class CreateProfilePayloadToDataCreateProfilePayloadConverter
        extends BaseConverter<CreateProfilePayload, org.tms.task_executor_service.persistent.entity.payload.CreateProfilePayload>
        implements PayloadMappingRegistrationVisitor {

    @Override
    public void convert(CreateProfilePayload source, org.tms.task_executor_service.persistent.entity.payload.CreateProfilePayload destination) {
