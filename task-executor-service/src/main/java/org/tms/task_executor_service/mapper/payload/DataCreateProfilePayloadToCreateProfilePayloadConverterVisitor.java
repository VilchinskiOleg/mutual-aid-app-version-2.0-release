...
@Component
public class DataCreateProfilePayloadToCreateProfilePayloadConverterVisitor
        extends BaseConverter<CreateProfilePayload, org.tms.task_executor_service.domain.model.payload.CreateProfilePayload>
        implements PayloadMappingRegistrationVisitor {

    @Override
    public void convert(CreateProfilePayload source, org.tms.task_executor_service.domain.model.payload.CreateProfilePayload destination) {
